...
function createKalmanFilterX(Q = 0.01, R = 0.001) {
  return new KalmanFilter1D(0, 0, Q, R)
}

function createKalmanFilterY(Q = 0.02, R = 0.001) {
  return new KalmanFilter1D(0, 0, Q, R)
}

function createKalmanFilterZ(Q = 0.01, R = 0.001) {
  return new KalmanFilter1D(0, 0, Q, R)
}

function createKalmanFilterVelX(Q = 0.05, R = 0.002) {
  return new KalmanFilter1D(0, 0, Q, R)
}

function createKalmanFilterVelY(Q = 0.1, R = 0.002) {
  return new KalmanFilter1D(0, 0, Q, R)
}

function createKalmanFilterVelZ(Q = 0.05, R = 0.002) {
  return new KalmanFilter1D(0, 0, Q, R)
}
...
class KalmanPacketLossTest {
  ...
  generateReport() {
    ...
    for (const criterion of criteria) {
      const icon = criterion.pass ? 'PASS' : 'FAIL'
